...
abstract: |
  ...
  The results of this study were consistent with the other finds in the research around where people are living and how that is connected to their health. There is strong evidence that suggests that the stability of a child's residence contributes to their well-being score. There should be more reseearch done. 
...
The current study was not preregistered. Data and code are available on Github [*click here*](https://github.com/libby-kramer/Residential_Instability_Project) Data retrieved from the 2024 Survey of Income and Program Participation <https://www.census.gov/programs-surveys/sipp/data/datasets/2024-data/2024.html>
...
The sample size after omitting the missing values, due to the vast amount of missing, was `r nrow(dat_sim)`. The average age of the respondents was `r dem_1_mean` with a standard deviation of `r dem_1_sd`. The participants were 89.8% female, 77.7% white, 10.5% Black, 7.90% Asian, and 3.48% were reported as residual. This sample size has some significant bias around sex and race. There answer options for the demographics were very binary and lacking in self-description options.
...
@kantz2023; @sociald; @bureau; @boch2021a
:::
